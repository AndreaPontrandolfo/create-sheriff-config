...
// node_modules/.pnpm/spdx-license-ids@3.0.12/node_modules/spdx-license-ids/deprecated.json
var require_deprecated = __commonJS({
  "node_modules/.pnpm/spdx-license-ids@3.0.12/node_modules/spdx-license-ids/deprecated.json"(exports, module2) {
    module2.exports = [
      "AGPL-1.0",
      "AGPL-3.0",
...
var require_git_host_info = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/git-host-info.js"(exports, module2) {
    "use strict";
    ...
    var defaults = {
      ...
      browsefiletemplate: ({ domain, user, project, committish, treepath, path: path5, fragment, hashformat }) => `https://${domain}/${user}/${project}/${treepath}/${maybeEncode(committish || "master")}/${path5}${maybeJoin("#", hashformat(fragment || ""))}`,
      docstemplate: ({ domain, user, project, treepath, committish }) => `https://${domain}/${user}/${project}${maybeJoin("/", treepath, "/", maybeEncode(committish))}#readme`,
      httpstemplate: ({ auth, domain, user, project, committish }) => `git+https://${maybeJoin(auth, "@")}${domain}/${user}/${project}.git${maybeJoin("#", committish)}`,
      filetemplate: ({ domain, user, project, committish, path: path5 }) => `https://${domain}/${user}/${project}/raw/${maybeEncode(committish) || "master"}/${path5}`,
    ...
    gitHosts.github = Object.assign({}, defaults, {
      ...
      domain: "github.com",
      treepath: "tree",
      filetemplate: ({ auth, user, project, committish, path: path5 }) => `https://${maybeJoin(auth, "@")}raw.githubusercontent.com/${user}/${project}/${maybeEncode(committish) || "master"}/${path5}`,
    ...
    gitHosts.gist = Object.assign({}, defaults, {
      ...
      browsefiletemplate: ({ domain, project, committish, path: path5, hashformat }) => `https://${domain}/${project}${maybeJoin("/", maybeEncode(committish))}${maybeJoin("#", hashformat(path5))}`,
    ...
    gitHosts.sourcehut = Object.assign({}, defaults, {
      ...
      domain: "git.sr.ht",
      treepath: "tree",
      browsefiletemplate: ({ domain, user, project, committish, treepath, path: path5, fragment, hashformat }) => `https://${domain}/${user}/${project}/${treepath}/${maybeEncode(committish || "main")}/${path5}${maybeJoin("#", hashformat(fragment || ""))}`,
      filetemplate: ({ domain, user, project, committish, path: path5 }) => `https://${domain}/${user}/${project}/blob/${maybeEncode(committish) || "main"}/${path5}`,
...
var require_git_host = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/git-host.js"(exports, module2) {
    "use strict";
    ...
    var GitHost = class {
      ...
      browse(path5, fragment, opts) {
        if (typeof path5 !== "string") {
          return this._fill(this.browsetemplate, path5);
        }
        if (typeof fragment !== "string") {
          opts = fragment;
          fragment = null;
        }
        return this._fill(this.browsefiletemplate, { ...opts, fragment, path: path5 });
      }
      docs(opts) {
      ...
      file(path5, opts) {
        return this._fill(this.filetemplate, { ...opts, path: path5 });
      }
...
var require_hosted_git_info = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/index.js"(exports, module2) {
    "use strict";
    var url = require("url");
    var gitHosts = require_git_host_info();
...
var require_extract_description = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/extract_description.js"(exports, module2) {
...
var require_typos = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/typos.json"(exports, module2) {
    module2.exports = {
      topLevel: {
...
var require_fixer = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/fixer.js"(exports, module2) {
...
var require_warning_messages = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/warning_messages.json"(exports, module2) {
    module2.exports = {
...
var require_make_warning = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/make_warning.js"(exports, module2) {
    var util = require("util");
...
var require_normalize = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/normalize.js"(exports, module2) {
...
// src/utils/setSheriffConfig.ts
var import_fs = require("fs");

// node_modules/.pnpm/read-pkg-up@9.1.0/node_modules/read-pkg-up/index.js
...
// node_modules/.pnpm/read-pkg@7.1.0/node_modules/read-pkg/index.js
...
var toPath3 = (urlOrPath) => urlOrPath instanceof URL ? (0, import_node_url3.fileURLToPath)(urlOrPath) : urlOrPath;
async function readPackage({ cwd, normalize = true } = {}) {
  cwd = toPath3(cwd) || import_node_process2.default.cwd();
  const filePath = import_node_path3.default.resolve(cwd, "package.json");
  const json = (0, import_parse_json.default)(await import_node_fs2.promises.readFile(filePath, "utf8"));
  if (normalize) {
...
async function pathExists2(p) {
  try {
    await import_fs2.promises.access(p);
    return true;
  } catch {
    return false;
  }
...
var setEslintConfig = async () => {
  ...
  try {
    ...
    (0, import_fs3.writeFileSync)(ESLINT_CONFIG_FILE_NAME, eslintConfigRawText);
  } catch (error) {
    printError("Couldn't walk up the filesystem", { error });
  }
};

// src/utils/setPrettierConfig.ts
var import_fs4 = require("fs");
var prettierConfigRawText = `{
  "trailingComma": "all",
  "singleQuote": true,
  "endOfLine": "auto"
}`;
var setPrettierConfig = async () => {
  const { packageJson } = await getPackageJsonContents();
  ...
  try {
    ...
    (0, import_fs4.writeFileSync)(PREFERRED_PRETTIER_CONFIG_FILE_NAME, prettierConfigRawText);
  } catch (error) {
    printError("Couldn't walk up the filesystem", { error });
  }
};
