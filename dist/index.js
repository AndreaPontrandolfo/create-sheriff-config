...
async function readPackage({ cwd, normalize = true } = {}) {
  cwd = toPath3(cwd) || import_node_process8.default.cwd();
...
var getRequiredPackages = async () => {
  ...
  if (!userProjectDependencies.eslint) {
    ...
    updateSpinnerText("Installing 'eslint' and 'eslint-config-sheriff'...");
...
var setEslintConfig = async () => {
  ...
  try {
    ...
    (0, import_fs3.writeFileSync)("eslint.config.js", eslintConfigRawText);
  } catch (error) {
